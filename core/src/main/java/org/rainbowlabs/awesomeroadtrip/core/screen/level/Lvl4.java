package org.rainbowlabs.awesomeroadtrip.core.screen.level;
...
public class Lvl4 implements Screen {
    ...
    public Lvl4(AwesomeRoadTrip awesomeRoadTrip) {
        // Placement of background asset
        mapSprite = new Sprite(new Texture(Gdx.files.internal("Lvl4.jpg"))); //<-- Place your lvl background here
